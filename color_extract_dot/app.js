...
class App{
    constructor(){
        ...
        this.canvas.addEventListener('clickright')
    }
    ...
    drawImage(){
        ...
        if(imgRatio > stageRatio){
            ...
            this.imgPos.x = Math.round(
                (this.stageWidth / this.image.width) / 2
            )
        }
        else{
            ...
            this.imgPos.y = Math.round(
                (this.stageHeight / this.image.height) / 2
            );
        }
        ...
        // console.log(`this tmpCtx ${this.imgData.data}`);
    }
    ...
    drawDots(){
        ...
        for(let i = 0 ; i < this.rows ; i++){
            ...
            for(let j = 0 ; j < this.colums; j++){
                ...
                const dot = new Dot(pixelX,pixelY,this.radius, this.pixelSize,
                     red, green, blue);
